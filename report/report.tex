...
%We formalize this property in \TODO{\RefFig{}}.\\
...
Now, let's consider the case where the programmer made a mistake while writing this code, and forgot to send back a failure notification when the authentication fails, such as in \RefCode{lst:atmmistake}.

The linearity checker will realize that the linear \stt{cont} is not consumed in every branch of the pattern match, and will pinpoint its introduction:
